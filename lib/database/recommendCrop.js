...
export const recommendCrop = async (soil) => {
  ...
  // Soil moisture isn't part of this match — the dataset's "humidity" column
  // is regional air humidity from where each crop was historically grown,
  // not soil moisture, so comparing the two wasn't a meaningful signal.
