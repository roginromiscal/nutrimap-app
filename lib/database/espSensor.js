// The ESP32 runs its own WiFi access point ("NutriMap-Sensor") instead of
// joining the phone's network, so its address is always the ESP32 SoftAP
// default gateway — no discovery step needed, just connect the phone to
// that WiFi first.
...
// Lightweight connectivity check for the Sensors tab's online/offline
// indicator — separate from fetchSensorReading because "is the device
// reachable" and "is a sensor reading ready yet" aren't the same thing.
